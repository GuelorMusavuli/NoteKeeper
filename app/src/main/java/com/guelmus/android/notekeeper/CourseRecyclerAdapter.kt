...
import com.guelmus.android.notekeeper.CourseInfo
import com.guelmus.android.notekeeper.R
...
class CourseRecyclerAdapter(private val context: Context, private val courses: List<CourseInfo>) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        //Reference the view within item_course_list to display the courses
        val textCourse: TextView = itemView.findViewById(R.id.textCourse) as TextView
        var coursePosition = 0

        //ClickHandler at the top-level view for a particular item in the grid
        init {
